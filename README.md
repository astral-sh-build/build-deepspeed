...
```console
$ uv add deepspeed --index astral-cu128=https://wheels.astralshosted.com/simple/cu128/
```
...
```console
$ uv pip install --index https://wheels.astralshosted.com/simple/cu128/ deepspeed
```
